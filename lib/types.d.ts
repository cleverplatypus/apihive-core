...
export type RequestInterceptor = (config: RequestConfig, controls: RequestInterceptorControls) => Promise<any | undefined>;
export type RequestConfigBuilder = (request: HTTPRequest, config: RequestConfig) => void;
/**
 * @internal
 */
...
export type APIConfig<TApiConfig extends BaseAPIInterface = DefaultAPIConfig> = {
     ...
     */
    responseInterceptors?: ResponseInterceptor | ResponseInterceptorWithOptions | Array<ResponseInterceptor | ResponseInterceptorWithOptions>;
     ...
     */
    endpoints: TApiConfig extends {
        endpoints?: never;
    } ? never : TApiConfig extends {
