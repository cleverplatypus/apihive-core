...
function getEndpointURL(endpoint, api) {
...
export class HTTPRequestFactory {
    constructor() {
        ...
        this.adapterRequestInterceptors = [];
        this.adapterResponseInterceptors = [];
        this.adapterErrorInterceptors = [];
        this.adapterInterceptorApplier = null;
    }
    /**
    ...
    async withAdapter(adapter, options) {
        ...
        // Attach the adapter
        await ((_a = adapter.onAttach) === null || _a === void 0 ? void 0 : _a.call(adapter, this));
    ...
    async detachAdapter(adapterName) {
        ...
        await ((_b = (_a = entry.adapter).onDetach) === null || _b === void 0 ? void 0 : _b.call(_a, this));
     ...
     * @internal
     */
    registerAdapterInterceptors(adapter, priority) {
        var _a, _b, _c;
     ...
     * @internal
     */
    unregisterAdapterInterceptors(adapter) {
        var _a, _b, _c;
        const requestInterceptors = ((_a = adapter.getRequestInterceptors) === null || _a === void 0 ? void 0 : _a.call(adapter)) || [];
        const responseInterceptors = ((_b = adapter.getResponseInterceptors) === null || _b === void 0 ? void 0 : _b.call(adapter)) || [];
        const errorInterceptors = ((_c = adapter.getErrorInterceptors) === null || _c === void 0 ? void 0 : _c.call(adapter)) || [];
        // Remove from adapter interceptor arrays
        this.adapterRequestInterceptors = this.adapterRequestInterceptors.filter((entry) => !requestInterceptors.includes(entry.interceptor));
        // Build a set of function references for comparison
        const responseFns = new Set(responseInterceptors.map((e) => typeof e === 'function' ? e : e.interceptor));
        this.adapterResponseInterceptors = this.adapterResponseInterceptors.filter((stored) => {
            const fn = typeof stored.entry === 'function'
                ? stored.entry
                : stored.entry.interceptor;
            return !responseFns.has(fn);
        });
        this.adapterErrorInterceptors = this.adapterErrorInterceptors.filter((entry) => !errorInterceptors.includes(entry.interceptor));
    ...
    updateAdapterInterceptorApplier() {
        ...
        if (this.adapterRequestInterceptors.length > 0 ||
    ...
    createAPIRequest(...args) {
        ...
        try {
            ...
            this.logger.error("Unable to merge meta", ...additionalInfo, e);
        }
